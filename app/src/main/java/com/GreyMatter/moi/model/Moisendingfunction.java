...
public class Moisendingfunction {
    String id,imgview,funname,funplace,fundate;

    public Moisendingfunction() {

    }

    public Moisendingfunction(String id, String imgview, String funname, String funplace, String fundate) {
        this.id = id;
